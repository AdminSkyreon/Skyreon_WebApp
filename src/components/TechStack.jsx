    ...
    <section id="tech-stack" className="py-16 sm:py-24 bg-[#fbfbfd] text-slate-900 font-sans border-t border-slate-200/60 relative overflow-hidden select-none">
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-8 relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 gap-6">
          ...
          >
            <p className="text-xs font-semibold text-red-400 uppercase tracking-[0.2em] mb-2">{category}</p>
            ...
            >
              ...
              <div className="md:col-span-7 p-6 sm:p-8 flex flex-col justify-between bg-white">
                ...
                <div className="pt-4 border-t border-slate-100 mt-auto flex items-center justify-start">
                  <Link 
                    href={`/tech/${item.id}`}
                    className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-full bg-red-500 hover:bg-red-600 text-white text-xs sm:text-sm font-semibold transition-all duration-300 shadow-md shadow-red-500/20 active:scale-95 cursor-pointer"
                  >
