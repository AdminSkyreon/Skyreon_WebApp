  ...
  return (
    <footer className="bg-slate-900 text-slate-200 pt-16 pb-8 border-t border-slate-700/60 relative z-10 overflow-hidden shadow-2xl">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {/* Main Grid Section */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 pb-12 border-b border-slate-700/60 items-start">
          ...
          <div className="space-y-2 -ml-1">
            ...
            <Link
              href="/"
              className="block h-[40px] w-[330px] overflow-hidden leading-none hover:opacity-90 transition-opacity"
            >
              <img
                src="/skyreon/hero/logo8.png"
                alt="Skyreon"
                className="block h-[150px] w-auto max-w-none object-contain brightness-0 invert origin-left-center scale-[1.90] -translate-y-[59px] -translate-x-[8px]"
              />
            </Link>

            {/* Description */}
            <p className="text-slate-300 text-sm max-w-sm leading-relaxed mt-0">
