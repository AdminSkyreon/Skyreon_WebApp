          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-3 pt-2">
              <a 
                ...
                target="_blank" 
                rel="noreferrer" 
                className="w-10 h-10 rounded-xl bg-slate-800 border border-slate-700 hover:border-rose-500/50 hover:bg-slate-700 text-slate-300 hover:text-rose-400 flex items-center justify-center transition-all duration-300 transform hover:-translate-y-1 hover:shadow-lg hover:shadow-rose-500/20"
              >
              ...
              {footerData.navigationLinks?.map((item, index) => (
                <li key={index}>
                  <a 
                    ...
                    className="inline-block text-slate-300 hover:text-rose-400 hover:translate-x-1.5 transition-all duration-200 cursor-pointer"
                  >
                    {item.label}
                  </a>
                </li>
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-400">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              onClick={scrollToTop}
              title="Back to top"
              className="p-2 rounded-lg bg-slate-800 border border-slate-700 text-slate-300 hover:text-rose-400 hover:border-rose-500/50 transition-all cursor-pointer hover:-translate-y-1 shadow-md"
            >
