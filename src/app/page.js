...
// Component Imports (Navbar & Sections - Insights removed)
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-cyan-500 selection:text-white overflow-x-hidden relative">
      
      {/* Light Background Gradients */}
      <div className="absolute inset-0 bg-[linear-gradient(to_right,#e2e8f0_1px,transparent_1px),linear-gradient(to_bottom,#e2e8f0_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_30%,#000_70%,transparent_100%)] z-0" />
      <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-cyan-400/20 rounded-full blur-3xl animate-pulse z-0" />
      <div className="absolute top-1/3 right-1/4 w-96 h-96 bg-blue-500/15 rounded-full blur-3xl animate-pulse z-0" />
      ...
      <section className="relative pt-32 md:pt-40 pb-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 min-h-screen flex items-center z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 w-full items-center">
          ...
          <div className="lg:col-span-7 text-left flex flex-col justify-center">
            ...
            >
              <span className="inline-flex px-3.5 py-1.5 text-xs font-bold tracking-wider text-cyan-700 uppercase bg-cyan-100/80 rounded-full border border-cyan-300/60 mb-6 shadow-sm">
                {heroData.badgeTag}
              </span>
            </motion.div>
            ...
            >
              ...
              <a 
                href="#tech-stack" 
                className="px-8 py-3.5 rounded-full bg-white hover:bg-slate-100 text-slate-800 border border-slate-300 font-bold text-sm transition-all active:scale-95 shadow-sm inline-flex items-center justify-center"
              >
          ...
          <div className="lg:col-span-5 flex flex-col items-center justify-center relative">
            <motion.div 
              ...
              className="mb-6 bg-white border border-slate-200 p-5 rounded-2xl rounded-bl-none shadow-xl max-w-xs text-left relative z-20"
            >
